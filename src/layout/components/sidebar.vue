<template>
  <div>
    <div class="h-[var(--header-height)] title">
      <div class="light flex h-full items-center text-lg">
        <a class="flex h-full items-center gap-2 overflow-hidden px-3 text-lg leading-normal transition-all duration-500">后台管理系统</a>
      </div>
